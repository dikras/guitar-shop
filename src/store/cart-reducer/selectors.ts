...
export const getGuitarToCountQuantity = (state: State, uniqID: string | undefined): number| undefined => state[NameSpace.cart].guitarsToCount.find((guitar) => guitar.uniqID === uniqID)?.quantity;
